...
You cannot simply give a URL to a scraper if the content is protected by a login page, and I wanted to pass the login programmatically from my code. That is where Puppeteer comes in.
